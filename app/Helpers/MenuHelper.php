...
class MenuHelper
{
        ...
        return [
            [
             ...
             [
                ...
                'name' => 'Products',
                'subItems' => [
                    ['name' => 'Add Products', 'path' => '/admin/products/create'],
                    ['name' => 'View Products', 'path' => '/admin/products', 'pro' => false],
                ],
            ],
             [
                'icon' => 'category',
                'name' => 'Categories',
                'subItems' => [
                    ['name' => 'Add Categories', 'path' => '/admin/categories/create'],
                    ['name' => 'View Categories', 'path' => '/admin/categories', 'pro' => false],
                ],
            ],
             ...
             [
                ...
                'name' => 'Brands',
                'subItems' => [
                    ['name' => 'Add Brands', 'path' => '/admin/brands/create'],
                    ['name' => 'View Brands', 'path' => '/admin/brands', 'pro' => false],
                ],
            ],
             ...
             [
                ...
                'name' => 'Orders',
                'subItems' => [
                    ['name' => 'View Orders', 'path' => '/admin/orders', 'pro' => false],
                ],
            ],
             ...
             [
                ...
                'name' => 'Shipping',
                'subItems' => [
                    ['name' => 'Shipping Classes', 'path' => '/admin/shipping-classes', 'pro' => false],
                    ['name' => 'States', 'path' => '/admin/states', 'pro' => false],
                    ['name' => 'Lagos Locations', 'path' => '/admin/lagos-locations', 'pro' => false],
                ],
            ],
             ...
             [
                ...
                'name' => 'Users',
                'subItems' => [
                    ['name' => 'View Users', 'path' => '/admin/users', 'pro' => false],
                ],
            ],
            ...
            //     'name' => 'Coupons',
            //     'subItems' => [
            //         ['name' => 'Add Coupons', 'path' => '/admin/coupons/create'],
            //         ['name' => 'View Coupons', 'path' => '/admin/coupons', 'pro' => false],
            //     ],
            // ],
    ...
    public static function getIconSvg($iconName)
    {
        $icons = [
            ...
            // New icons for menu items that didn't have them
            'product' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 7L7.5 5L12 7L16.5 5L21 7M3 7V17C3 18.1046 3.89543 19 5 19H19C20.1046 19 21 18.1046 21 17V7M3 7L7.5 9M21 7L16.5 9M7.5 9L3 11M16.5 9L21 11M7.5 9V17C7.5 17.5523 7.94772 18 8.5 18H15.5C16.0523 18 16.5 17.5523 16.5 17V9M7.5 9C7.5 9.55228 7.94772 10 8.5 10H15.5C16.0523 10 16.5 9.55228 16.5 9Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',

            'category' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4 7C4 5.89543 4.89543 5 6 5H18C19.1046 5 20 5.89543 20 7V17C20 18.1046 19.1046 19 18 19H6C4.89543 19 4 18.1046 4 17V7Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M12 12H16M8 12H10M8 16H14" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',

            'brand' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 16C14.2091 16 16 14.2091 16 12C16 9.79086 14.2091 8 12 8C9.79086 8 8 9.79086 8 12C8 14.2091 9.79086 16 12 16Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M15 9L9 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path><path d="M9 9L15 15" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',

            'order' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9 5H7C5.89543 5 5 5.89543 5 7V19C5 20.1046 5.89543 21 7 21H17C18.1046 21 19 20.1046 19 19V7C19 5.89543 18.1046 5 17 5H15M9 5C9 5.55228 9.44772 6 10 6C10.5523 6 11 5.55228 11 5C11 4.44772 10.5523 4 10 4C9.44772 4 9 4.44772 9 5ZM15 5C15 5.55228 15.4477 6 16 6C16.5523 6 17 5.55228 17 5C17 4.44772 16.5523 4 16 4C15.4477 4 15 4.44772 15 5ZM9 12H15M9 16H13M5 10H19V14H5V10Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',

            'shipping' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M21 16H18.5C20.433 16 22 14.433 22 12.5C22 10.567 20.433 9 18.5 9H5.5C3.567 9 2 10.567 2 12.5C2 14.433 3.567 16 5.5 16H3M7 9V21M17 9V21M8 9C8 9 8.5 6.5 12 6.5C15.5 6.5 16 9 16 9M8 9C8 9 8.5 11.5 12 11.5C15.5 11.5 16 9 16 9" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',

            'users' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M17 21V19C17 17.9391 16.5786 16.9217 15.8284 16.1716C15.0783 15.4214 14.0609 15 13 15H5C3.93913 15 2.92172 15.4214 2.17157 16.1716C1.42143 16.9217 1 17.9391 1 19V21M16 7C16 8.06087 15.5786 9.07828 14.8284 9.82843C14.0783 10.5786 13.0609 11 12 11C10.9391 11 9.92172 10.5786 9.17157 9.82843C8.42143 9.07828 8 8.06087 8 7C8 5.93913 8.42143 4.92172 9.17157 4.17157C9.92172 3.42143 10.9391 3 12 3C13.0609 3 14.0783 3.42143 14.8284 4.17157C15.5786 4.92172 16 5.93913 16 7ZM23 21C23 19.4087 22.3679 17.8826 21.2426 16.7574C20.1174 15.6321 18.5913 15 17 15H7C5.4087 15 3.88258 15.6321 2.75736 16.7574C1.63214 17.8826 1 19.4087 1 21M13 3C13 4.06087 12.5786 5.07828 11.8284 5.82843C11.0783 6.5786 10.0609 7 9 7C7.93913 7 6.92172 6.5786 6.17157 5.82843C5.42143 5.07828 5 4.06087 5 3C5 1.93913 5.42143 0.921721 6.17157 0.171573C6.92172 -0.578575 7.93913 -1 9 -1C10.0609 -1 11.0783 -0.578575 11.8284 0.171573C12.5786 0.921721 13 1.93913 13 3Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',

            'coupons' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15 21H9C7.34315 21 6 19.6569 6 18V15M18 15V18C18 19.6569 16.6569 21 15 21H9C7.34315 21 6 19.6569 6 18V15M18 15C18 15 17.5 13 15 13H9C6.5 13 6 15 6 15M18 15V9C18 7.34315 16.6569 6 15 6H9C7.34315 6 6 7.34315 6 9V15M18 9C18 9 17.5 11 15 11H9C6.5 11 6 9 6 9M12 3V7M8 3H16C17.1046 3 18 3.89543 18 5V6C18 7.10457 17.1046 8 16 8H8C6.89543 8 6 7.10457 6 6V5C6 3.89543 6.89543 3 8 3Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',

            'external-link' => '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M18 13V19C18 19.5304 17.7893 20.0391 17.4142 20.4142C17.0391 20.7893 16.5304 21 16 21H5C4.46957 21 3.96086 20.7893 3.58579 20.4142C3.21071 20.0391 3 19.5304 3 19V8C3 7.46957 3.21071 6.96086 3.58579 6.58579C3.96086 6.21071 4.46957 6 5 6H11M15 3H21M21 3V9M21 3L13 11" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>',
        ];
