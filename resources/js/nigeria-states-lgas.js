/**
 * Nigeria States and LGAs Dataset
 * Source: Public administrative data
 * Format: { State: [LGA1, LGA2, ...] }
 */
...
export const NigeriaStatesAndLGAs = {
    ...
    "Delta": [
        ...
        "Ukwuani","Uvwie","Warri North","Warri South",
        "Warri South West"
    ],
    ...
    "Edo": [
        ...
        "Oredo","Orhionmwon","Ovia North-East","Ovia South-West",
    ...
    "Imo": [
        ...
        "Ideato North","Ideato South","Ihitte/Uboma",
        "Ikeduru","Isiala Mbano","Isu","Mbaitoli",
        "Ngor Okpala","Njaba","Nkwerre","Nwangele",
    ...
    "Osun": [
        "Atakunmosa East","Atakunmosa West","Aiyedaade",
        "Aiyedire","Boluwaduro","Boripe","Ede North",
        "Ede South","Egbedore","Ejigbo","Ife Central",
        "Ife East","Ife North","Ife South","Ifedayo",
        "Ifelodun","Ila","Ilesa East","Ilesa West",
        "Irepodun","Irewole","Isokan","Iwo",
        "Obokun","Odo Otin","Ola Oluwa","Olorunda",
        "Oriade","Orolu","Osogbo"
    ],
