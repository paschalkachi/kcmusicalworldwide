<div class="relative" x-data="{
    ...
    >
        <span class="mr-3 overflow-hidden rounded-full h-11 w-11">
            <img src="{{ auth()->user()->profile_image ? asset('uploads/profile/' . auth()->user()->profile_image) : asset('images/logo/logo-icon.png') }}" alt="User" />
        </span>

       <span class="block mr-1 font-medium text-theme-sm">{{ auth()->user()->name ?? 'Admin User' }}</span>
    ...
    >
        ...
        <div>
            ...
            <span class="mt-0.5 block text-theme-xs text-gray-500 dark:text-gray-400">{{ auth()->user()->email ?? 'No email' }}</span>
        </div>
