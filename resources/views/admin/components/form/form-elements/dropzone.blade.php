{{-- <x-common.component-card title="Dropzone"> --}}
    ...
    class="transition border border-gray-300 border-dashed cursor-pointer rounded-xl
           hover:border-brand-500 dark:border-gray-700 dark:hover:border-brand-500"
>
...
>
 ...
 <!-- Preview Grid -->
    ...
    <!-- Hidden inputs to submit existing filenames (keeps existing gallery files on submit) -->
    {{-- <template x-for="(item, index) in files" :key="index">
        <input type="hidden" name="existing_images[]" x-bind:value="item.name" x-show="item.isExisting">
    </template> --}}
