                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90">
                            {{ json_decode(auth()->user()->address, true)['country'] ?? 'Country not set' }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90">
                            {{ json_decode(auth()->user()->address, true)['city_state'] ?? 'City/State not set' }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90">
                            {{ json_decode(auth()->user()->address, true)['postal_code'] ?? 'Postal Code not set' }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-sm font-medium text-gray-800 dark:text-white/90">
                            {{ json_decode(auth()->user()->address, true)['tax_id'] ?? 'Tax ID not set' }}
                        </p>
                    </div>
                </div>
            </div>
