...
<section class="text-black dark:text-white py-12 md:py-16">
    <div class="px-4 md:px-6 mx-auto max-w-7xl">
        ...
        <p class="text-light-black text-lg">Your favorite products in one place</p>
    </div>
</section>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div id="sidebar-nav" class="lg:col-span-1 hidden lg:block absolute lg:relative z-10 w-64 lg:w-auto bg-white dark:bg-gray-800 lg:bg-transparent p-6 rounded-xl shadow-md lg:shadow-none mt-2 lg:mt-0 ml-4 lg:ml-0">
            <div class="sticky top-20 space-y-3 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md">
                ...
                <a href="{{ route('user.wishlist') }}" class="block px-4 py-3 rounded-lg bg-brand-600 text-white font-medium transition-colors">
                    Wishlist
                </a>
        ...
        <div class="lg:col-span-3">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 md:p-8">
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-6">Your Wishlist</h2>

                <div class="text-center py-12">
                    <svg class="mx-auto h-16 w-16 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                    </svg>
                    <h3 class="mt-4 text-lg font-medium text-gray-900 dark:text-white">Your wishlist is empty</h3>
                    <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                        Save products you like for later. Start browsing our collection now.
                    </p>
                    <div class="mt-6">
                        <a href="{{ route('shop') }}" class="px-4 py-2 bg-brand-600 hover:bg-brand-700 dark:bg-brand-700 dark:hover:bg-brand-800 text-white rounded-lg font-medium transition-colors text-sm">
                            Browse Products
                        </a>
                    </div>
                </div>
